...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(
              ...
              valueColor: _statusColor(widget.order.status, context),
  ...
  Widget _buildInfoRow(String label, String value, {Color? valueColor, FontWeight valueWeight = FontWeight.normal}) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 8),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Color _labelColor(BuildContext context) {
    ...
    // In dark mode, use full white; in light mode, use a softened onSurface
