      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            FutureBuilder<bool>(
              future: _hasInsufficientStock(cart),
              builder: (context, snapshot) {
                final hasInsufficient = snapshot.data == true;
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: (cart.items.isEmpty || hasInsufficient)
                            ? null
                            : () {
...
Future<bool> _hasInsufficientStock(CartProvider cart) async {
                ...
                children: [
                  ...
                  FutureBuilder<Map<String, dynamic>?>(
                    future: Supabase.instance.client
                        ...
                        .maybeSingle(),
                    builder: (context, snapshot) {
                      final stock = (snapshot.data?['stock'] ?? 0) as int;
                      final insufficient = stock < cartItem.quantity;
                      return Row(
                        children: [
                          Text(
                            'In stock: $stock',
